...
const Third = () => {
  ...
  const womenImages = [
    ...
    const sliderSettings = {
      ...
      infinite: true,
      speed: 3000,
      slidesToShow: window.innerWidth <= 425 ? 1 : 3, // Show 1 slide on mobile, 3 slides otherwise
      slidesToScroll: 1,
      autoplay: true,
      autoplaySpeed: 3000,
        ...
        <div className="third-main-content">
          ...
          <div className="toggle-switch">
            ...
            >
              ...
              />
              <div className="toggle-label-content">Women</div>
            </label>
            ...
            >
              ...
              />
              <div className="toggle-label-content">Men</div>
            </label>
